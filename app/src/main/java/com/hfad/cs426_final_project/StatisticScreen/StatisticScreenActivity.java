    ...
    public class StatisticScreenActivity extends AppCompatActivity {
        ...
        private void initializeComponents() {
            ...
            landView = findViewById(R.id.hexagonalLandView);
            initializeHexagonalLandscapeView();
        ...
        private void initializeHexagonalLandscapeView() {
            landView.post(() -> {
                int viewWidth = landView.getWidth();

                int desiredColumns = 8;

                float tileWidth = viewWidth / (desiredColumns * 0.75f);
                landView.setTileSize(tileWidth);
            });
        }
